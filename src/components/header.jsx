...
//                     <Button
//                         variant="contained"
//                         sx={{ textTransform: 'none', background: '#019376' }}
//                     >
//                         Join
//                     </Button>
//                     <Button
    ...
    return (
        <AppBar position="sticky" color="default" elevation={0} className="py-2">
            <Toolbar>
                ...
                {/* Buttons - Responsive Logic */}
                <Box sx={{ display: 'flex', gap: 1 }}>
                    {/* "Join" button - Visible on Medium and Larger Screens */}
                    <Button
                        variant="contained"
                        sx={{ 
                    ...
                    {/* "Become a Seller" button - Visible on Tablet (md) and Larger Screens */}
                    <Button
                        variant="contained"
                        sx={{ 
                            display: { xs: 'none', sm: 'flex' }, // Show only from "sm" and up
                            textTransform: 'none', 
                            background: '#019376' 
                        }}
                    >
