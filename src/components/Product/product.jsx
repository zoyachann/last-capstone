...
// const [state, setState] = useState(false); // Top-level hook call
    
// if (state) {
//     console.log("State is true");
// }
//   const isMobileOrTablet = useMediaQuery("(max-width: 992px)"); // For tablet & mobile screens
...
//   return (
//     <Box 
//     className="d-flex bg-body-tertiary my-5 ">
...
//                   src={Product.img}
//                   onClick={() => {
//                     navigate(`./ProductDetails/ProductDetail/${Product?.id}`);
//                   }}
//                 />
//               </Box>
...
const Products = () => {
  ...
  const isMobileOrTablet = useMediaQuery("(max-width: 992px)"); // Media query for responsive design
            ...
            >
              ...
              >
                <img
                  ...
                  src={Product.img}
                  alt={Product.title}
                  onClick={() => navigate(`./ProductDetails/ProductDetail/${Product?.id}`)}
                />
              </Box>
              <Typography variant="body" className="mt-3 fw-bold">
                {Product?.title}
